...
def main():
    try:
        ...
        Trapes = []         # berenging av motorpådrag B
        Flow = []
        ...
        while True:
            ...
            if k == 0:
                ...
                MeasurementToFileHeader += "0=Tid, 1=Lys, 2=Trapes, 3=Flow\n"
            ...
            if len(filenameCalcOnline)>4:
                if k == 0:
                    ...
                    CalculationsToFileHeader += "2=Trapes, 3=Flow \n"
