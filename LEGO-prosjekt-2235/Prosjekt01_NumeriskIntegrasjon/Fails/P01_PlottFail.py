...
def unpackMeasurement(rowOfMeasurement):
    ...
    Flow.append(float(rowOfMeasurement[3]))
    
    T_S.append(float(rowOfMeasurement[4]))
    Volum.append(float(rowOfMeasurement[5]))
